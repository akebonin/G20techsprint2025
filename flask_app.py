...
def get_simulated_farm_data():
    df = pd.read_csv('/home/AlisGraveNil/mysite/cassava_farm_data.csv')
...
def update_loan_status():
    ...
    if status == 'authorized':
        existing.update({
            'status': status,
            'contractAddress': contract_address or "0x45fC082AE2B9E17673359E0Ae79D6af4119B3B29",
...
def get_federated_insights():
    try:
        csv_path = '/home/AlisGraveNil/mysite/federated_farm_data.csv'
